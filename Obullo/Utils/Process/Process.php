...
class Process
{
    ...
    protected $stdout;
    protected $stderr;
    protected $enhanceWindowsCompatibility;
    protected $enhanceSigchildCompatibility;
    protected $process;
    protected $status = self::STATUS_READY;
    protected $incrementalOutputOffset;
    protected $incrementalErrorOutputOffset;
    protected $tty;
    ...
    {
        $this->stop();  // stop() will check if we have a process running.
    }
     ...
     */
    protected function captureExitCode()
    {
